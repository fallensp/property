...
export default function ListingCreatePage() {
  ...
  const tryResolvePropertyTypeIds = useListingStore((state) => state.tryResolvePropertyTypeIds);
  ...
  // In update mode, eagerly fetch metadata and resolve property type IDs
  // This ensures IDs are resolved without needing to visit the Location step
  useEffect(() => {
    if (isUpdateMode) {
      fetchMetadata().then(() => {
  ...
  }, [isUpdateMode, fetchMetadata, tryResolvePropertyTypeIds]);
