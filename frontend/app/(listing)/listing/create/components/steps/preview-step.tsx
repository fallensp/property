...
export function PreviewStep(_: StepProps) {
  ...
  const updateStatus = useListingStore((state) => state.updateStatus);
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Choose whether to keep this listing as a draft or publish it live.
              </p>
              <Select
                value={draft.status}
                onValueChange={(value) => updateStatus(value as typeof draft.status)}
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="online">Online (public)</SelectItem>
                </SelectContent>
              </Select>
            </div>
